{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "5ec251d9-a7fc-4aa1-abfe-228409831063",
        ...
        {
          "id": "e991470c-9a40-4693-b9c1-b2f180ce28f5",
          "type": "basic.output",
          "data": {
            "name": "SERVO",
            "pins": [
        ...
        {
          "id": "06b067dc-faa2-4847-a9ae-14caa5267236",
        ...
        {
          "id": "885df490-aec5-4d64-ae25-40d70d211679",
          "type": "basic.input",
          "data": {
            "name": "BOTON",
            "pins": [
        ...
        {
          "id": "6b570c49-1b7a-44da-b926-3f462bd61d6b",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
      ...
      "wires": [
        {
          "source": {
            "block": "5ec251d9-a7fc-4aa1-abfe-228409831063",
            "port": "eac2d6e9-4a62-4aec-8ce8-0e6c54e14d22"
          },
          "target": {
            "block": "e991470c-9a40-4693-b9c1-b2f180ce28f5",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "06b067dc-faa2-4847-a9ae-14caa5267236",
        ...
        {
          "source": {
            "block": "885df490-aec5-4d64-ae25-40d70d211679",
            "port": "out"
          },
          "target": {
            "block": "06b067dc-faa2-4847-a9ae-14caa5267236",
        ...
        },
        {
          ...
          "target": {
            "block": "6b570c49-1b7a-44da-b926-3f462bd61d6b",
            "port": "in"
          },
          "vertices": [
            {
