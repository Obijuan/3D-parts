{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "eee3938b-8837-451c-8704-7a21fff4acef",
        ...
        {
          "id": "d02002a8-82d1-4baa-95b2-ace757c3d8e9",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "17241487-3f88-45a6-8d02-9a7ca7141dca",
          "type": "basic.input",
          "data": {
            "name": "Button",
            "pins": [
        ...
        {
          "id": "7c6be1b1-b3a3-479e-998f-ee01f91d3c96",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
      ...
      "wires": [
        {
          "source": {
            "block": "eee3938b-8837-451c-8704-7a21fff4acef",
            "port": "eac2d6e9-4a62-4aec-8ce8-0e6c54e14d22"
          },
          "target": {
            "block": "d02002a8-82d1-4baa-95b2-ace757c3d8e9",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "17241487-3f88-45a6-8d02-9a7ca7141dca",
            "port": "out"
          },
          "target": {
            "block": "eee3938b-8837-451c-8704-7a21fff4acef",
        ...
        },
        {
          ...
          "target": {
            "block": "7c6be1b1-b3a3-479e-998f-ee01f91d3c96",
            "port": "in"
          },
          "vertices": [
            {
